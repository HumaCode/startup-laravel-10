    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Anda akan mengakhiri sesi login sekarang..?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger waves-effect" data-bs-dismiss="modal">Tidak</button>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    this.closest('form').submit();"
                        class="btn btn-primary waves-effect waves-light">Ya</a>
                </form>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
